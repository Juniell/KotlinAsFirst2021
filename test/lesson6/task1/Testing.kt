...
class Testing {
    ...
    fun mostExpensive() {
        ...
        Assertions.assertEquals("Шоколадка", mostExpensive("Булочка 40; Шоколадка 490; Газировка 89; Чипсы 96"))
        Assertions.assertEquals("Шоколадка", mostExpensive("Булочка 40.0; Шоколадка 490.0; Газировка 89.0; Чипсы 96.0"))
        Assertions.assertEquals("Шоколадка", mostExpensive("Булочка 40; Шоколадка 490.0; Газировка 89.0; Чипсы 96"))
        ...
        Assertions.assertEquals("Максимальный", mostExpensive("Первый 1; Второй 2; Опять_второй 2; Максимальный 3"))
        Assertions.assertEquals("Максимальный", mostExpensive("Первый 1; Второй 2.0; Опять_второй 2; Максимальный 3"))
        Assertions.assertEquals(
            "Максимальный",
        ...
        Assertions.assertEquals("Булочка", mostExpensive("Булочка 40; Булочка 490.0; Булочка 89.0; Булочка 96"))
        Assertions.assertEquals("Шоколадка", mostExpensive("Булочка 40; Шоколадка 490.0; Булочка 89.0; Булочка 96"))
        Assertions.assertEquals("Шоколадка", mostExpensive("Булочка 40; Шоколадка 490.0; Булочка 89.0; Шоколадка 96"))
        Assertions.assertEquals("Шоколадка", mostExpensive("Булочка 40; Шоколадка 490.0; Булочка 89.0; Шоколадка 960"))
        Assertions.assertEquals("Булочка", mostExpensive("Булочка 1000; Шоколадка 490.0; Булочка 100.0; Шоколадка 96"))
        ...
        Assertions.assertEquals("Шоколадка", mostExpensive("Булочка ${Int.MAX_VALUE}0; Шоколадка 1${Double.MAX_VALUE}"))
        Assertions.assertEquals(
            "Булочка",
