...
class TestingAll {
    ...
    fun findSumOfTwo() {
        assertAll(
            ...
            { Assertions.assertEquals(Pair(1, 2), findSumOfTwo(listOf(1, 2, 3), 5)) },
            { Assertions.assertEquals(Pair(3, 4), findSumOfTwo(listOf(1, 10, 100, 1000, 10000, 20000), 11000)) },
            { Assertions.assertEquals(Pair(0, 5), findSumOfTwo(listOf(1, 10, 100, 1000, 10000, 20000), 20001)) },

            // 2. Отсутствие решения
            { Assertions.assertEquals(Pair(-1, -1), findSumOfTwo(listOf(1, 2, 3, 4, 5), 10)) },
            { Assertions.assertEquals(Pair(-1, -1), findSumOfTwo(listOf(1, 1, 1, 1, 1), 3)) },

            // 3. Работа с пустым списком
            { Assertions.assertEquals(Pair(-1, -1), findSumOfTwo(listOf(), 10)) },
            { Assertions.assertEquals(Pair(-1, -1), findSumOfTwo(listOf(), 0)) },

            // 4. Работа со списком из одного элемента
            { Assertions.assertEquals(Pair(-1, -1), findSumOfTwo(listOf(1), 1)) },
            { Assertions.assertEquals(Pair(-1, -1), findSumOfTwo(listOf(1), 2)) },

            // 5. Работа с 0
            { Assertions.assertEquals(Pair(-1, -1), findSumOfTwo(listOf(1, 2, 0), 0)) },
            { Assertions.assertEquals(Pair(0, 1), findSumOfTwo(listOf(0, 0), 0)) },
            { Assertions.assertEquals(Pair(0, 2), findSumOfTwo(listOf(0, 100, 0), 0)) },
            ...
            { Assertions.assertEquals(Pair(-1, -1), findSumOfTwo(listOf(5, 4, 2), 8)) },
            { Assertions.assertEquals(Pair(-1, -1), findSumOfTwo(listOf(1, 2, 1, 1, 1), 4)) },
            { Assertions.assertEquals(Pair(1, 2), findSumOfTwo(listOf(3, 1, 5), 6)) },
            ...
            {
                val resInd1 = findSumOfTwo(listOf(11, 5, 10, 3), 14)
                val resInd2 = findSumOfTwo(listOf(3, 5, 10, 11), 14)
            ...
            {
                val resPair1 = findSumOfTwo(listOf(1, 1, 1), 2)
                Assertions.assertTrue(resPair1 == Pair(0, 1) || resPair1 == Pair(0, 2) || resPair1 == Pair(1, 2))
            },
            {
                val resPair2 = findSumOfTwo(listOf(0, 1, 2, 3, 4, 5), 5)
